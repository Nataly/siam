...
function InsertarDatos(){
		...
		$.ajax({
			url: 'item_nuevo.php',
			type: "POST",
			data: "submit=&idformato="+idformato+"&idservicio="+idservicio+"&idcentro="+idcentro+"&descripcion="+descripcion+"&justificacion="+justificacion+"&estatus="+estatus+"&Hobservacion="+Hobservacion,
