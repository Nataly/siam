...
<html lang="es">
    <head>
        ...
        <meta name="author" content="compuiter de Venezuela C.A">
        ...
        <link rel="shortcut icon" href="<?php echo $baseUrl; ?>/img/icons/plus.png">
        ...
        $cs->registerCssFile($baseUrl . '/css/jquery-ui-custom.css');
	...
	$.jgrid.useJSON = true;
        ...
        $cs->registerScriptFile($baseUrl . '/js/jquery-ui-custom.min.js');
        ?>
    </head>
